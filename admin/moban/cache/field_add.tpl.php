...
<div class="luatop">
	<div class="position">Lua：CMS  > <a href="./model.htm">模型管理</a> > <a href="./model.htm?action=table&amp;id=<?=$model_id?>"><?=$mdb['modelname']?></a> > <a href="./model.htm?action=field&amp;model_id=<?=$model_id?>&amp;id=<?=$table_id?>">【<?php echo isset($tdb['modelname']) ? $tdb['modelname'] : "";?>】字段列表</a> > 新增字段</div>
</div>
<div class="clear"></div>
...
<table cellpadding="2" cellspacing="1" class="table">
	...
	<tr> 
		...
		<td colspan="2" class="input">
			<select name="fieldtype"><? if(is_array($types)) { foreach($types as $k => $v) { ?><option value="<?=$k?>"><?=$v?></option><? } } ?></select>
		</td>
	</tr> 
	<tr> 
	...
	<tr> 
		<td class="text"></td>
		<td class="submit"><input type="submit" name="submit" value="保存" class="submit" onclick="post('./model.htm?action=save_field&model_id=<?=$model_id?>&table_id=<?=$table_id?>');"/></td>
	</tr>
</table>
