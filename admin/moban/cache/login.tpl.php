...
<div class="login-min">
			...
			<div class="login-right">	
				...
				<form method="post" action="./login.htm" name="main_login">
					...
					<p><label>口令卡</label><input type="text" class="text" style='width:50px;' name="cardit" maxlength='6'/>&nbsp;&nbsp;<span style="padding:3px;color:white;background:#38687E;font-weight:bold;"><?=$aaaa?> <?=$bbbb?></span></p>
					<? } ?>
