...
<div class="luatop">
	<div class="position">Lua：CMS  > <a href="./admin.htm">管理员管理</a> > <a href="./admin.htm?action=perm_category&amp;uid=<?=$uid?>">栏目权限设置</a> > 管理员：<?=$udb['username']?></div>
</div>
<div class="clear"></div>
...
<div class="stat_list" style="padding-left:24px;margin:0px;">
	<ul>
		<li class="<? if(empty($lua)) { ?>now<? } ?>"><a href="./admin.htm?action=perm_category&amp;uid=<?=$uid?>">栏目权限</a></li>
		<li class="<? if($lua == 'piece') { ?>now<? } ?>"><a href="./admin.htm?action=perm_category&amp;uid=<?=$uid?>&amp;lua=piece">碎片栏目权限</a></li>
	</ul>
</div>
			...
			<form method="post" id="myform" onsubmit="return false;">
			 <table cellpadding="0" cellspacing="0" class="table neitable columntables" style="margin:0px; border:none;">
				<tr id="list-top">
					...
					<td class="list-text"><? if($v['add_perm'] == 1) { ?><input type="checkbox" name="can[]" value="<?=$v['id']?>" /><? } else { ?>--<? } ?></td>
