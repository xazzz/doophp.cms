...
<table cellpadding="2" cellspacing="1" class="table">
	...
	<tr>
		...
		<td class="list-text color999"><a href="./admin.htm?action=makecard&amp;uid=<?=$v['uid']?>">生成<? if($v['secureid']) { ?><font color='green'>(<b>√</b>)</font><? } ?></a> <a href="./admin.htm?action=clear&amp;uid=<?=$v['uid']?>">清除</a></td>
		...
		<td class="list-text"><a href="./admin.htm?action=edit&amp;uid=<?=$v['uid']?>">编辑</a>&nbsp;&nbsp;<? if($v['perm'] != SUPER_MAN) { ?><a href="./admin.htm?action=perm&amp;uid=<?=$v['uid']?>">系统</a>&nbsp;&nbsp;<a href="./admin.htm?action=perm_category&amp;uid=<?=$v['uid']?>">权限</a>&nbsp;&nbsp;<? } ?><a href="./admin.htm?action=del&amp;uid=<?=$v['uid']?>" onclick="return confirm('确认要删除此管理用户吗?');">删除</a></td>
	</tr>
	<? } } ?></table>
<script>
