...
<div class="luatop">
	<div class="position">Lua：CMS  > <a href="./member.htm?action=model">会员模型</a> > <a href="./member.htm?action=model_field&amp;id=<?=$model_id?>">【<?php echo isset($model_db['modelname']) ? $model_db['modelname'] : "";?>】字段管理</a> > 设置选项 ( <font color="red"><?=$db['name']?></font> )</div>
</div>
<div class="clear"></div>
...
<table cellpadding="0" cellspacing="0" class="table">
	...
	<tr> 
		...
		<td class="all-submit" style="padding:5px 0px;">
			<input name="submit" type='submit' value='保存' class="submit li-submit" onclick="post('./member.htm?action=save_field_option&model_id=<?=$model_id?>&id=<?=$id?>');"/>
