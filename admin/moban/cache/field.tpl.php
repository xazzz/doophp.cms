...
<div class="luatop">
	<div class="position">Lua：CMS  > <a href="./model.htm">模型管理</a> > <a href="./model.htm?action=table&amp;id=<?=$mid?>"><?=$mdb['modelname']?></a> > 【<?php echo isset($db['modelname']) ? $db['modelname'] : "";?>】字段列表</div>
</div>
<div class="clear"></div>
