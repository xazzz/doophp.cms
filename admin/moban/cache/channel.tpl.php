	...
	<tr>
		<td class="centle" height="20" colspan="9" style="font-weight:normal;">
			<div style="float:left;">
				&nbsp;&nbsp;<a href="./channel.htm?action=add">+添加频道</a>
				&nbsp;&nbsp;<a href="./channel.htm?action=scan">导入频道</a>
			</div>
		</td>
	</tr>
	<tr>
		...
		<td class="list-text"><a href="./channel.htm?action=edit&amp;id=<?=$v['id']?>">编辑</a>&nbsp;&nbsp;<a href="./channel.htm?action=del&amp;id=<?=$v['id']?>" onclick="return confirm('确认要删除此频道吗?');">删除</a>&nbsp;&nbsp;<a href="javascript:;" onclick="__def(<?=$v['id']?>);" title="设为默认显示"><? if($v['isdefault'] == 0) { ?>默认<? } else { ?><font color="red">取消</font><? } ?></a>&nbsp;&nbsp;<a href="./channel.htm?action=export&amp;id=<?=$v['id']?>">导出</a></td>
	</tr>
	<? } } ?></table>
