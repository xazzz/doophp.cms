...
/*
 * $dbconfig["X15"] = array("localhost", "phpwind", "root", "", "mysql", true, "collate"=>"utf8_unicode_ci", "charset"=>"utf8"); 
 ...
 * 
 * require_once LUA_ROOT.ADMIN_ROOT.'/plugin/passport/api/discuzX1.5.php';
 * $uc = new ucenter();
 * $this->user = $uc->user();
 */
...
class ucenter extends DooController{
    ...
    public $cookiepre = '9KDm_';
    
    // 在 config/config_global.php 里查找 authkey
    public $authkey = 'c51805qDCrRnHhtS';
