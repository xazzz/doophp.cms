 ...
 * 
 * require_once LUA_ROOT.ADMIN_ROOT.'/plugin/passport/api/phpwind7.0.php';
 * $uc = new ucenter();
 * $this->user = $uc->user();
 */
...
class ucenter extends DooController{
    ...
    public $db_sitehash = '10V1RaAAQGU1dRDwsDCQMGWgZSVQZdXQFUUgsGC1YHBVs';
    
    // data/bbscache/config.php 里查找 db_hash
    public $db_hash = '9k27zBIC$';
