 ...
 * 
 * require_once LUA_ROOT.ADMIN_ROOT.'/plugin/passport/api/phpwind8.5.php';
 * $uc = new ucenter();
 * $this->user = $uc->user();
 */
...
class ucenter extends DooController{
    ...
    public $db_sitehash = '10AQAHWwABDlNaAFBXB1AEAgJXD1IMVwIDUAlQVgpQBww';
    
    // data/bbscache/config.php 里查找 db_hash
    public $db_hash = '40^&*z5&p';
    
    // data/bbscache/config.php 里查找 db_cookiepre
    public $db_cookiepre = '83707';
