...
/*
 * $dbconfig["dz5"] = array("localhost", "phpwind", "root", "", "mysql", true, "collate"=>"utf8_unicode_ci", "charset"=>"utf8"); 
 ...
 * 
 * require_once LUA_ROOT.ADMIN_ROOT.'/plugin/passport/api/discuz5.0.php';
 * $uc = new ucenter();
 * $this->user = $uc->user();
 */
...
class ucenter extends DooController{
    ...
    public $authkey = 'aHizKG8Yct67Nj9';
    ...
    public function user(){
        $_DCOOKIE = array();
        $prelength = strlen($this->tablepre);
        foreach($_COOKIE as $key => $val) {
            if(substr($key, 0, $prelength) == $this->tablepre) {
