...
/*
 * $dbconfig["pw7"] = array("localhost", "phpwind", "root", "", "mysql", true, "collate"=>"utf8_unicode_ci", "charset"=>"utf8"); 
 ...
 * 
 * require_once LUA_ROOT.ADMIN_ROOT.'/plugin/passport/api/phpwind7.5.php';
 * $uc = new ucenter();
 * $this->user = $uc->user();
 */
...
class ucenter extends DooController{
    ...
    public $db_sitehash = '10ClNUU1QHVAJVBV0HVVIBBFZRUAIEWFIBUwMBVVQHAlA';
    
    // data/bbscache/config.php 里查找 db_hash
    public $db_hash = '5&^QrN%1^&';
    
    // data/bbscache/config.php 里查找 db_cookiepre
    public $db_cookiepre = '58d95';
    ...
    public function CookiePre(){
        return ($this->db_cookiepre) ? $this->db_cookiepre : substr(md5($this->db_sitehash),0,5);
    }
