 ...
 * 
 * require_once LUA_ROOT.ADMIN_ROOT.'/plugin/passport/api/phpwind7.3.2.php';
 * $uc = new ucenter();
 * $this->user = $uc->user();
 */
...
class ucenter extends DooController{
    ...
    public $db_sitehash = '10AQ8DVFEBC1ZUVVQDU1cLAQcOBAdWAFYOVwgAAAYBU1o';
    
    // data/bbscache/config.php 里查找 db_hash
    public $db_hash = '72%NVzIEzc';
