 ...
 * 
 * require_once LUA_ROOT.ADMIN_ROOT.'/plugin/passport/api/phpwind8.0.php';
 * $uc = new ucenter();
 * $this->user = $uc->user();
 */
...
class ucenter extends DooController{
    ...
    public $db_sitehash = '10VgFXAwcCAQdaUlEHVFxRUAJdAQkDBgBcBwBWAFMBU1I';
    
    // data/bbscache/config.php 里查找 db_hash
    public $db_hash = '^&5Qa%2%EI';
    
    // data/bbscache/config.php 里查找 db_cookiepre
    public $db_cookiepre = '08e60';
