 ...
 * 
 * require_once LUA_ROOT.ADMIN_ROOT.'/plugin/passport/api/phpwind8.3.php';
 * $uc = new ucenter();
 * $this->user = $uc->user();
 */
...
class ucenter extends DooController{
    ...
    public $db_sitehash = '10VlMCUwVTAABYBVNWVQdQCQNbA1ABBQRXVAYDAwUHV1U';
    
    // data/bbscache/config.php 里查找 db_hash
    public $db_hash = '*ewpk5V^i@';
    
    // data/bbscache/config.php 里查找 db_cookiepre
    public $db_cookiepre = 'ad697';
