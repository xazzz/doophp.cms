...
/*
 * $dbconfig["pw8"] = array("localhost", "phpwind", "root", "", "mysql", true, "collate"=>"utf8_unicode_ci", "charset"=>"utf8"); 
 ...
 * 
 * require_once LUA_ROOT.ADMIN_ROOT.'/plugin/passport/api/phpwind8.7.php';
 * $uc = new ucenter();
 * $this->user = $uc->user();
 */
...
class ucenter extends DooController{
    ...
    public $db_sitehash = '10AlRSV1ELAAIHAVtQV1YGA1RRAgFaVlADVAVTA1ZUBVU';
    
    // data/bbscache/config.php 里查找 db_hash
    public $db_hash = 'Y8oc@1loYN';
    
    // data/bbscache/config.php 里查找 db_cookiepre
    public $db_cookiepre = '1d9ac';
