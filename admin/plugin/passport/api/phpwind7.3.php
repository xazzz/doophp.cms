 ...
 * 
 * require_once LUA_ROOT.ADMIN_ROOT.'/plugin/passport/api/phpwind7.3.php';
 * $uc = new ucenter();
 * $this->user = $uc->user();
 */
...
class ucenter extends DooController{
    ...
    public $db_sitehash = '10AwoDAVEBClhYVgJQUVBQVlELUwUEVlMJVgUGA1UBUwU';
    
    // data/bbscache/config.php 里查找 db_hash
    public $db_hash = '9Tw%CBWk^%';
